...
##  [Train directory](https://github.com/pedrogbmendes/HPT_advTrain/tree/anonymize/train/README.md)

**The [directory `train`](https://github.com/pedrogbmendes/HPT_advTrain/tree/anonymize/train/README.md)  contains the scripts and information to deploy the training of models.**
...
## [Optimizers directory](https://github.com/pedrogbmendes/HPT_advTrain/tree/anonymize/optimizers/README.md)  

**The [directory `optimizers`](https://github.com/pedrogbmendes/HPT_advTrain/tree/anonymize/optimizers/README.md) contains the code to implement the hyper-parameter tuning optimizers** compared in this work (namely, taKG, HB, BO-EI, and Random Search).
...
## [Datasets directory](https://github.com/pedrogbmendes/HPT_advTrain/tree/anonymize/datasets/README.md)  

**The [directory `datasets`](https://github.com/pedrogbmendes/HPT_advTrain/tree/anonymize/datasets/README.md)  contains the data collected in our study.** We are making this data publicly accessible in the hope that it will aid the design of future HPT methods specialized for Adversarial Training. 
